...
def compute(n):
    ...
    load_file_name = '/home/chenchen/ame508/observation_data/' + str(n) + '.mat'
    save_file_name = '/home/chenchen/ame508/parafind/opt' + str(n) + '.mat'
    model_file_name = '/home/chenchen/ame508/trained_model/model_1000000'
    grid_file_name = '/home/chenchen/ame508/double_para/grid.mat'
    x_t,known_data = dataloading(load_file_name,grid_file_name)
    model = modeloading(model_file_name)
    a,loss = parafinder(model,x_t,known_data)
    scipy.io.savemat(save_file_name, {'a': a,'loss':loss})
...
if __name__ == '__main__':
  ...
  for _ in tqdm(pool.imap_unordered(compute, range(1,100)), total=len(range(1,100)), dynamic_ncols=True):
        pass