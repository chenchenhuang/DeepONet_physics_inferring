...
def dataloading(data_file_name):
  ...
  return x_t, known_data,known_index
...
def parafinder(model,x_t,known_data):
  ...
  for epoch in range(1,max_epoch+1):
      ...
      with tf.GradientTape() as tape:
          ...
          loss = tf.reduce_mean(tf.square(sample_output-known_data))
...
if __name__ == '__main__':
  ...
  data_file_name = '/Users/huangchenchen/Dropbox/AME508_Project/data_generating/'
  x_t,known_data,known = dataloading(data_file_name)
  model = modeloading()
